...
feature-object_tracker-too_many_obstacles = Path found, but {$count} obstacles in the way, more than the limit of {$limit}. Press the move key again to walk anyway.
